...
('grape','葡萄',1,'Downey_Mildew(白粉病)','Downey_Mildew','白粉病',NULL,'NONE','中英文标签疑似不一致（Downy/Downy mildew 通常指霜霉病），待人工核验，暂不映射',NULL, 0, NOW(3)),
...
('rice','水稻',4,'Scald(纹枯病)','Scald','纹枯病',NULL,'NONE','中英文标签疑似不一致（Scald 通常不是纹枯病），待人工核验，暂不映射',NULL, 0, NOW(3)),
